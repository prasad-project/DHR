...
import WorkerMedicalAIAssistant from "@/components/WorkerMedicalAIAssistant"
...
export default function WorkerDashboard() {
  ...
  return (
    ...
    <div>
      <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">AI Medical Assistant</h2>
      <div className="max-w-4xl mx-auto">
        <WorkerMedicalAIAssistant compact={true} />
      </div>
    </div>
